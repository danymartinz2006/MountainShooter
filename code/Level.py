...
class Level:
    def __init__(self, window, name, game_mode):
        ...
        self.entity_list += EntityFactory.get_entity('Player1')
        if game_mode in (MENU_OPTION[1], MENU_OPTION[2]):
            self.entity_list += EntityFactory.get_entity('Player2')
    ...
    def run(self, ):
        ...
        while True:
            ...
            self.level_text(14, f'fps: {clock.get_fps():.0f}', COLOR_WHITE, (13, WIN_HEIGHT - 35))
